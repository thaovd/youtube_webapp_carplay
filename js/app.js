...
(function () {
  ...
  function renderSettings() {
    ...
    view.replaceChildren(el("div", { class: "settings" }, [
      ...
      field("Chất lượng video ưu tiên", seg("quality", [["auto", "Tự động"], ["hd1080", "1080p"], ["hd720", "720p"], ["large", "480p"], ["medium", "360p"]]),
        "Chỉ là yêu cầu gửi tới YouTube; YouTube vẫn có thể tự điều chỉnh theo tốc độ mạng."),
